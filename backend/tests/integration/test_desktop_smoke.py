...
def test_versions_stay_in_lockstep() -> None:
    ...
    assert project_version == __version__ == APP_VERSION == "0.3.4"
    ...
    assert "StringStruct(u'ProductVersion', u'0.3.4')" in version_resource
...
def test_desktop_version_command_is_scriptable() -> None:
    ...
    assert completed.stdout.strip() == "Keshi 0.3.4"
